...
ALLOWED_HOSTS = environ.get("ALLOWED_HOSTS", "localhost,api").split(",")
...
MIDDLEWARE = [
    ...
    "api.middleware.ErrorCaptureMiddleware",
]
...
# CORS
######################################################################
CORS_ALLOW_ALL_ORIGINS = environ.get("CORS_ALLOW_ALL_ORIGINS", "true").lower() == "true"
